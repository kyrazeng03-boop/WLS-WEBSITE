// 网站固定界面文字的中英对照表 —— 用于导航栏"EN / 中文"切换按钮
// 注意：产品、新闻等从 Sanity 读取的实际内容不在这里翻译，保持原文（英文）
// key 命名规则：按"页面/组件.用途"来组织，方便查找和维护
export const translations = {
  ...
  'footer.contactHeading': { en: 'Contact', zh: '联系方式' },
  'footer.tel': { en: 'Tel', zh: '电话' },
  'footer.email': { en: 'Email', zh: '邮箱' },
  'footer.workingHours': { en: 'Working Hours', zh: '工作时间' },
  'footer.rights': { en: 'All rights reserved.', zh: '版权所有。' },

  // ---- Product categories (shared across site) ----
  'cat.outdoor': { en: 'Outdoor Lighting', zh: '户外照明' },
  'cat.commercial': { en: 'Commercial Lighting', zh: '商业照明' },
  'cat.smart': { en: 'Smart Lighting', zh: '智能照明' },
  'cat.furniture': { en: 'Furniture Lighting', zh: '家具照明' },
  'cat.dob-driver': { en: 'DOB Driver', zh: 'DOB驱动' },

  // ---- Shared buttons ----
  'btn.details': { en: 'Details', zh: '详情' },
  'btn.inquiryNow': { en: 'Inquiry Now', zh: '立即询价' },
  ...
  'about.workshop.eyebrow': { en: 'Inside WLS', zh: '走进威林胜' },
  'about.workshop.title': { en: 'Workshop Glance', zh: '车间一览' },
  ...
  'contact.office.china': { en: 'China Factory', zh: '中国工厂' },
  'contact.office.egypt': { en: 'Egypt Factory', zh: '埃及工厂' },
  'contact.label.whatsappRecommended': { en: 'WhatsApp (Recommended)', zh: 'WhatsApp（推荐）' },
  'contact.label.whatsappWechat': { en: 'WhatsApp / WeChat', zh: 'WhatsApp / 微信' },
  'contact.label.email': { en: 'Email', zh: '邮箱' },
  'contact.label.workingHours': { en: 'Working Hours', zh: '工作时间' },
  'contact.label.factoryAddress': { en: 'Factory Address', zh: '工厂地址' },
  'contact.qr.wechat': { en: 'WeChat', zh: '微信' },
  'contact.qr.whatsapp': { en: 'WhatsApp', zh: 'WhatsApp' },
  'contact.qr.comingSoon': { en: 'QR coming soon', zh: '二维码即将上线' },
  ...
  'coop.custom.cct.title': { en: 'Color Temperature', zh: '色温' },
  'coop.custom.cct.desc': { en: "Choose your CCT from warm 2700K to daylight 6500K, matched to your project's lighting scheme.", zh: '色温可选2700K暖光到6500K日光色，匹配您项目的照明方案。' },
  'coop.custom.size.title': { en: 'Size & Wattage', zh: '尺寸与功率' },
  'coop.custom.size.desc': { en: 'Custom panel dimensions and wattage output tailored to fit any fixture or project specification.', zh: '面板尺寸与功率均可定制，适配任何灯具或项目规格要求。' },
  ...
  'newsCat.industry': { en: 'Industry Insights', zh: '行业洞察' },
  'newsCat.case-study': { en: 'Case Study', zh: '案例研究' },
  ...
  'form.company': { en: 'Company', zh: '公司名称' },
  'form.country': { en: 'Country*', zh: '国家*' },
  'form.email': { en: 'Email*', zh: '邮箱*' },
  'form.phone': { en: 'WhatsApp / Phone', zh: 'WhatsApp / 电话' },
  'form.quantity': { en: 'Estimated Quantity', zh: '预计数量' },
  'form.quantityPlaceholder': { en: 'e.g. 500 units', zh: '例如：500件' },
  'form.businessType': { en: 'Business Type*', zh: '业务类型*' },
  'form.selectOption': { en: 'Select...', zh: '请选择...' },
  'form.distributorAgent': { en: 'Distributor / Agent', zh: '经销商 / 代理商' },
  'form.oemCustomization': { en: 'OEM / Customization', zh: 'OEM / 定制' },
  'form.projectBulkOrder': { en: 'Project / Bulk Order', zh: '项目 / 批量订单' },
  'form.message': { en: 'Message*', zh: '留言内容*' },
  'form.submit': { en: 'Send Inquiry', zh: '提交询盘' },
